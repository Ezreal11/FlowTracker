 ...
 */
public class MyFileAgent extends MyAgent {
    ...
    public MyFileAgent(Persistence persistence) {
        ...
        fileEditorManagerListener = new MyFileEditorManagerListener(persistence);
        ...
        virtualFileListener = new MyVirtualFileListener(persistence);
