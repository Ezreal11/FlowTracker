 ...
 */
public class MyExecuteAgent extends MyAgent {
    private MyExecutionListener executionListener;
    private ExecutionTargetListener executionTargetListener;

    public MyExecuteAgent(Persistence persistence) {
        super(persistence);

        this.executionListener = new MyExecutionListener(persistence);
        this.executionTargetListener = new MyExecutionTargetListener(persistence);
    ...
    public void addExecutionActivationListener(MyExecutionListener.ExecutionActivationListener l) {
        executionListener.addExecutionActivationListener(l);
    }

    public void removeExecutionActivationListener(MyExecutionListener.ExecutionActivationListener l) {
        executionListener.removeExecutionActivationListener(l);
    }
}
